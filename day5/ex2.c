...
#define ST_FMT "%010zu"
    ...
    //     // clang-format off
    //     printf("Seed %02zu: "ST_FMT", Soil: "ST_FMT", Fertilizer: "ST_FMT", Water: "ST_FMT", Light: "ST_FMT", Temperature: "ST_FMT",
    //     Humidity: "ST_FMT", Location: "ST_FMT"\n",
    //                  i+1,    m.seed,         m.soil,         m.fert,               m.water,         m.light,         m.temp, m.humid,
    //                  m.loc);
    //     // clang-format on
